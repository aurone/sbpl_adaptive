...
public:
    ...
    int replan(double allocated_time_secs, vector<int>* solution_stateIDs_V, int* cost){
     ...
     */
    int replan(double allocated_time_secs, double allocated_time_per_retry_plan_, double allocated_time_per_retry_track_, vector<int>* solution_stateIDs_V){
        int solcost = 0;
     ...
     */
    double get_final_epsilon(){return planner->get_final_epsilon() * tracker->get_final_epsilon(); };
