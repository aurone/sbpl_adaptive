...
class PViz
{
  public:
    ...
    bool computeFKforVisualizationWithKDL(const std::vector<double> &jnt0_pos, std::vector<double> &jnt1_pos, std::vector<double> &base_pos, double torso_pos, std::vector<geometry_msgs::PoseStamped> &poses, std::vector<int> &mesh_ids);
    ...
    void visualizeArmConfigurations(const std::vector<std::vector<double> > &traj, int arm, int throttle, std::string name, std::string frame_id);
    
    void visualizeArmConfiguration(const std::vector<double> &traj, int arm, double hue, std::string name, std::string frame_id);

    void visualizeRobotMeshes(double hue, std::string ns, int &start_id, std::vector<geometry_msgs::PoseStamped> &poses, std::vector<int> mesh_ids);
    ...
    inline void visualizeRobot(std::vector<double> &jnt0_pos, std::vector<double> &jnt1_pos, std::vector<double> &base_pos, double torso_pos, double hue, std::string ns){
      int start_id = 0;
      visualizeRobot(jnt0_pos, jnt1_pos, base_pos, torso_pos, hue, ns, start_id);
    }
    ...
    void visualizeRobot(std::vector<double> &jnt0_pos, std::vector<double> &jnt1_pos, BodyPose &body_pos, double hue, std::string ns);
